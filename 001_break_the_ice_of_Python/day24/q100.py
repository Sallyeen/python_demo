...
# input/output for clarification. If the following string is given as input to the program:
# 4 bcdef abcdefg bcde bcdef Then, the output of the program should be: 3 / 2 1 1
